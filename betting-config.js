// Wait for splToken to be available
function initBettingConfig() {
    // Make sure SPL Token is available
    if (typeof splToken === 'undefined') {
        console.error('SPL Token not loaded, waiting...');
        setTimeout(initBettingConfig, 100);
        return;
    }
    ...
    console.log('Betting config initialized successfully');
}

// Start initialization
document.addEventListener('DOMContentLoaded', initBettingConfig);